...
export function LogScreen({ session }: LogScreenProps) {
  const {
    loading,
    saving,
    error,
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-medium text-foreground mb-1">Log {monthLabel} 📝</h1>
          <p className="text-muted-foreground text-sm">Track your monthly income and allocations</p>
        </div>
      ...
      {saved && (
        <div className="rounded-xl p-4 flex items-start gap-3 bg-card border border-border">
          ...
          <div>
            <p className="font-medium text-foreground text-sm">Month logged successfully</p>
